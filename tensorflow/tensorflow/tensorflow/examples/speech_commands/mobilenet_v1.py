...
def mobilenet_v1_emb(inputs,
                 ...
                 scope='MobilenetV1',
                 global_pool=False):
  """Mobilenet v1 model for embedding generation.
  ...
  with tf.variable_scope(
    ...
    with slim.arg_scope([slim.batch_norm, slim.dropout],
      ...
      with tf.variable_scope('Embs'):
        ...
        # 1 x 1 x emb_size  ?
        embs = slim.conv2d(net, emb_size, [1, 1], activation_fn=None,
                             normalizer_fn=None, scope='Conv2d_1c_1x1')

        # TODO: normalize embeddings?

      end_points['Embs'] = embs
  return embs, end_points